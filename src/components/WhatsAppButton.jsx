  ...
  return (
    <>
      ...
      >
        ...
        {/* Glow effect */}
        <div className="absolute inset-0 bg-green-500 rounded-full opacity-0 group-hover:opacity-30 transition-opacity duration-300 blur-md" />
      </motion.a>
      ...
      >
        ...
        <div className="absolute right-0 top-1/2 transform translate-x-1 -translate-y-1/2">
          <div className="w-0 h-0 border-l-4 border-l-primary/30 border-t-4 border-t-transparent border-b-4 border-b-transparent" />
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="fixed bottom-16 right-14 bg-red-500 text-white text-xs font-bold w-6 h-6 rounded-full flex items-center justify-center z-50 animate-pulse"
      >
        1
      </motion.div>
      ...
      {Array.from({ length: 3 }, (_, i) => (
        <motion.div
          ...
          className="fixed bottom-20 right-12 bg-green-500 text-white px-3 py-1 rounded-lg text-xs font-medium pointer-events-none z-40"
          style={{
      ...
      <motion.div
        ...
        className="fixed bottom-0 right-0 w-32 h-32 bg-green-500/20 rounded-full blur-2xl pointer-events-none z-30"
      />
    </>
  )
}
